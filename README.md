...
#### Probleemstelling
Een beeldherkenningsapplicatie ontwikkelen die zal bijdragen aan de interactiviteit en technologisch integrering in scholen. De leraar kan zijn lessen voorbereiden en vragen erin betrekken en deze vragen direct toetsen en scannen met de applicatie om te zien hoe goed de leerlingen de stof opnemen. De leraar kan via een webapplicatie vragen voorbereiden voor de les. Deze lessen en respectievelijk de vragen worden dan via een projector getoond. De leerlingen hebben A4tjes met QR-codes of figuren met felle kleuren ter beschikking. Vervolgens steken de leerlingen deze figuren of QR-codes in de lucht.
