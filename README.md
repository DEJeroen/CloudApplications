...
#### Probleemstelling
Een beeldherkenningsapplicatie ontwikkelen die zal bijdragen aan de interactiviteit en technologisch integrering in scholen. De leraar kan via een webapplicatie vragen voorbereiden voor de les. Deze lessen en respectievelijk de vragen worden dan via een projector getoond. De leerlingen hebben A4tjes met QR-codes of figuren met felle kleuren ter beschikking. Aan de hand van testen zullen we besluiten welke figuren dit zijn. Op dit moment zijn deze nog niet bekend Vervolgens steken de leerlingen deze figuren of QR-codes in de lucht.
